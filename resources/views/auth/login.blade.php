    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="text-center">
            <a href="index.html" aria-label="Space">
                <img class="mb-3 logo-image" src="assets/style_login/image/logo2.png" alt="Logo" width="150" height="150">
            </a>
          </div>
        ...
        <p class="small text-center text-muted mb-0">All rights reserved. © Space. 2020 IFID</p>
    </form>
</div>
